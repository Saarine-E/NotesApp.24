...
function AddCourseInput({ OnClickFnc }){
    ...
    return (
        <div className="grid grid-cols-4 col-span-4 row-span-2">
            ...
            <input type="text" id="inputfield" value={inputValue} onChange={(e) => setInputValue(e.target.value)} placeholder="Enter name" className="mx-2 px-3 shadow-inner shadow-slate-400 border-x border-b border-slate-700 rounded-b-md col-span-3 row-start-2" />
            <button 
